			...
			<div class="panel">
				...
				<div class="well hidden-print">
					...
					{if $invoicefox_id!='' && $invoicefox_info['doc_num']==''}
						 <a id="finalizebttn" class="btn btn-default" href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&amp;action=finalize&amp;id_order={$order->id|intval}&amp;configure=invoicefox&amp;tab_module=others&amp;module_name=invoicefox">
							{l s='Finalize invoice'}
						</a>
					{elseif $invoicefox_id!='' && $invoicefox_info['doc_num']!=''}
						<a id="desc-order-print" class="btn btn-default" target='blank' href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&amp;action=print&amp;id_order={$order->id|intval}&amp;configure=invoicefox&amp;tab_module=others&amp;module_name=invoicefox&amp;hstyle=basicVER3">
							
							{l s='Print'}
						</a>
						<a id="desc-order-printupn" class="btn btn-default" target='blank' href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&amp;action=printupn&amp;id_order={$order->id|intval}&amp;configure=invoicefox&amp;tab_module=others&amp;module_name=invoicefox&amp;hstyle=basicVER3UPN">
							{l s='Print UPN'}
						</a>
						{if $invoicefox_id!='' && $invoicefox_info['is_finalize']=='1'}
						<a id="fiscolizeebttn" class="btn btn-default" target='blank' href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&amp;action=fiscol&amp;id_order={$order->id|intval}&amp;configure=invoicefox&amp;tab_module=others&amp;module_name=invoicefox">
							{l s='Get fiscal info'}
						</a>
						{/if}
					{/if}
