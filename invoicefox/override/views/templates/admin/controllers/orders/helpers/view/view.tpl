		...
		<div class="col-lg-7">
			<div class="panel">
				...
				<div class="well hidden-print">
					...
					{/if} 
					&configure=invoicefox&tab_module=others&module_name=invoicefox
					<div style='margin-top:10px'>
					{if $invoicefox_id!='' && $invoicefox_info['doc_num']==''}
						 <a id="desc-order-finalize" class="btn btn-default" href="#finalize">
							<i class="icon-exchange"></i>
							{l s='Finalize invoice'}
						</a>
					{elseif $invoicefox_id!='' && $invoicefox_info['doc_num']!=''}
						<a id="desc-order-print" class="btn btn-default" href="#print">
							<i class="icon-exchange"></i>
							{l s='Print'}
						</a>
						<a id="desc-order-printupn" class="btn btn-default" href="#printupn">
							<i class="icon-exchange"></i>
							{l s='Print UPN'}
						</a>
					{/if}
